  ...
  return (
    <div className={Style.settings}>
              <div className={Style.settingsContainer}>
                {response}
                {data.map((item, index) => {
                    const { _id, adminname, about, facebook, twitter, linkedin, instagram, youtube, copytext, footerText, adminlogo, adminPic} = item
                  return(
                  ...
                  <div className={Style.button}>
                    <Link to={`/settings/${_id}`} state={{_id}}>Edit Info</Link>
                  </div>
                </div>
                  )
                })}
