  ...
  return (
    <>
        ...
        <img
          src={
            ...
            "https://tanvirblog007-71b473c5e0c8.herokuapp.com" +
              data.postbanner.replace("public", "")
          }
          alt=""
        />
      </div>
      <div className={Style.content}>
        ...
        <p className={Style.body}>{data.description.slice(0, 500)}</p>
        <p className={Style.body}>{data.description.slice(501, 1000)}</p>
        <p className={Style.body}>{data.description.slice(1001, -1)}</p>
      </div>
    </>
  );
}
